...
public class apps {
    ...
    public static void main(String[] args) throws Exception{
        ...
        String options="enter 0 for finish process \n"
                ...
                +"enter 6 for show all users number of friends \n"
                ...
                +"enter 9 for see all posts details,posted user name,post likes,post shares,post comments \n"
                +"enter 10 for see all comments using only post_id\n"
                +"enter 11 for see list of friends name and User id and gender\n"
                +"enter 12 for find all pages all members details  \n"
                +"enter 13 for delete any comment and see comment likes also delete\n"
                +"enter 14 for see user who liked any post comments \n";
        boolean flag=true;
        int opt=0,cnt=0,id;
        while(flag) {
            ...
            switch(opt) {
                ...
                case 6:
                    try {
                        query="CALL `social_media_management`.`number_of_friends`()";
                        rs=st.executeQuery(query);
